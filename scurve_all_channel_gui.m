function [scurve,mean_th,mean_enc,M_O_mean_Th,M_O_mean_Th_std,M_O_mean_ENC,M_O_mean_ENC_std] = scurve_all_channel_gui(start_chan,stop_chan,step_chan,Latency,LV1As,arm_dac,D1,D2,DELAY,start_fc,stop_fc,fc_arr,dac,calpulse)
...
y = scurve(i,:);
%subplot(12,11,i);
[fitresult,~]=createFit_scurve(x,y);
mean_enc(i) = fitresult.b;
mean_th(i) = fitresult.a;
