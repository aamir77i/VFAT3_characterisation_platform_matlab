...
%% armdac to fc routine @ all gains full scale 
% 
...
[Arming_fit_LG,~] = ArmFit_fc(arm_dac_arr_LG(1:end -3),Threshold_arr_LG(1:end -3),leg,x_label,y_label,VFAT3_NUMBER,"LG",Peaking_time);
...
arm_dac=arm_dac+25;
 ...
 %% linear fitting
[Arming_fit_MG,~] = ArmFit_fc(arm_dac_arr_MG(1:end -3),Threshold_arr_MG(1:end -3),leg,x_label,y_label,VFAT3_NUMBER,"MG",Peaking_time);
...
arm_dac=arm_dac+25;
 ...
 %% linear fitting
[Arming_fit_HG,~] = ArmFit_fc(arm_dac_arr_HG(1:end -3),Threshold_arr_HG((1:end -3)),leg,x_label,y_label,VFAT3_NUMBER,"HG",Peaking_time);
...
%%
save('ArmDac_fc_all_gain.mat','Arming_fit_LG','Arming_fit_MG','Arming_fit_HG');