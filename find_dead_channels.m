...
scurve_store  = sum(scurve')
scurve_store  = (sum(scurve'))'
dead_channels = find(~scurve_store)
...
filename = horzcat(deadchannelsSubFolder,'/deadchannels_',VFAT3_NUMBER,d,'.txt');
