...
title('ESD4-D1-IV (full Curve)(Beam Analysis)')
xlabel('voltage(V)');
ylabel('current(A)');
%%
...
grid on
legend('pre','0.6MRAD','5.9MRAD','10MRAD');
title('ESD4-D1-IV (right most part)(Beam Analysis)')
xlabel('voltage(V)');
ylabel('current(A)');
%%
...
grid on
legend('pre','0.6MRAD','5.9MRAD','10MRAD');
title('ESD4-D1-IV (centre part)(Beam Analysis)')
xlabel('voltage(V)');
ylabel('current(A)');
%%
...
grid on
legend('pre','0.6MRAD','5.9MRAD','10MRAD');
title('ESD4-D1-IV (centre part zoomed)')
xlabel('voltage(v)');
ylabel('current(A)');

%%
avalanche_Index = zeros(1,4);
