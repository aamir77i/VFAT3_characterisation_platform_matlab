...
Trim_dac_array(uint16(Arming_th-2),:) = Trim_dac_rounded; 
end
%%
figure
...
axis([3 10 -70 70])
x_data= [3:10]';
x_data = repmat(x_data,1,128);
y_data = Trim_dac_array(:,:);
%%
clear trim_arr_final
for i = 1:128 
trimfunc_ssp=smoothing_spline(x_data(:,i), y_data(:,i));
for j = 3 : 10
    trim_arr_final(j-2,i) = round(trimfunc_ssp(j+.5));
end
end
%%

Trim_mode = mode(Trim_dac_array(:,:));

%%
Trim_mean = round(mean(Trim_dac_array,1)');
%%
for ADDRESS=0 : 127
    write_register(ADDRESS,sign_bit_conversion(round(Trim_mode(ADDRESS+1))));
end
%%
figure();
ch_arr=1:128;
plot(ch_arr,Trim_dac_array(1,:),ch_arr,Trim_dac_array(5,:));
...
fprintf('\n Plotting scurve plots ,please wait\n');
for i= 0 : 127
    write_register(i,sign_bit_conversion(trim_arr_final(1,i+1)));% writing correct trimming value in local channel register

 end
Arming_th1 = 3.5;
arm_dac1 = Arming_fit(Arming_th1);
 
[scurve_T1,mean_th_T1,mean_enc_T1,M_O_mean_Th_T1,M_O_mean_Th_std_T1,M_O_mean_ENC_T1,M_O_mean_ENC_std_T1] = scurve_all_channel(start_chan,stop_chan,step_chan,Latency,LV1As,arm_dac1,D1,D2,DELAY,start_fc,stop_fc,fc_arr,dac,calpulse);
 

for i= 0 : 127
    write_register(i,sign_bit_conversion(trim_arr_final(2,i+1)));% writing correct trimming value in local channel register

 end
% scurve at 2fc
Arming_th2 = 4.5;
arm_dac2 = Arming_fit(Arming_th2);
 
[scurve_T2,mean_th_T2,mean_enc_T2,M_O_mean_Th_T2,M_O_mean_Th_std_T2,M_O_mean_ENC_T2,M_O_mean_ENC_std_T2] = scurve_all_channel(start_chan,stop_chan,step_chan,Latency,LV1As,arm_dac2,D1,D2,DELAY,start_fc,stop_fc,fc_arr,dac,calpulse);
 

for i= 0 : 127
    write_register(i,sign_bit_conversion(trim_arr_final(3,i+1)));% writing correct trimming value in local channel register

 end
% scurve at 3fc
Arming_th3 = 5.5;
arm_dac3 = Arming_fit(Arming_th3);
 
[scurve_T3,mean_th_T3,mean_enc_T3,M_O_mean_Th_T3,M_O_mean_Th_std_T3,M_O_mean_ENC_T3,M_O_mean_ENC_std_T3] = scurve_all_channel(start_chan,stop_chan,step_chan,Latency,LV1As,arm_dac3,D1,D2,DELAY,start_fc,stop_fc,fc_arr,dac,calpulse);
 % scurve at 2fc
 
 
 
 for i= 0 : 127
    write_register(i,sign_bit_conversion(trim_arr_final(4,i+1)));% writing correct trimming value in local channel register

 end
Arming_th4 = 6.5;
arm_dac4 = Arming_fit(Arming_th4);
 
[scurve_T4,mean_th_T4,mean_enc_T4,M_O_mean_Th_T4,M_O_mean_Th_std_T4,M_O_mean_ENC_T4,M_O_mean_ENC_std_T4] = scurve_all_channel(start_chan,stop_chan,step_chan,Latency,LV1As,arm_dac4,D1,D2,DELAY,start_fc,stop_fc,fc_arr,dac,calpulse);
 % scurve at 2fc
 
 
 for i= 0 : 127
    write_register(i,sign_bit_conversion(trim_arr_final(5,i+1)));% writing correct trimming value in local channel register

 end
Arming_th5 = 7.5;
arm_dac5 = Arming_fit(Arming_th5);
 
[scurve_T5,mean_th_T5,mean_enc_T5,M_O_mean_Th_T5,M_O_mean_Th_std_T5,M_O_mean_ENC_T5,M_O_mean_ENC_std_T5] = scurve_all_channel(start_chan,stop_chan,step_chan,Latency,LV1As,arm_dac5,D1,D2,DELAY,start_fc,stop_fc,fc_arr,dac,calpulse);
...
str0 = ['',VFAT3_NUMBER];
str1 = ['ArmDac:',num2str(Arming_th1),'fC (',num2str(Arming_th1 * 6241.51),'e)','(',num2str(arm_dac1),')'];
str2 = ['',num2str(Pre_Gain),',',num2str(Peaking_time)];
x0=5;y0=stop_fc -.5;
x1=x0;y1=y0-2;
x2=x0;y2=y1-2;
...
str0 = ['',VFAT3_NUMBER];
str1 = ['ArmDac:',num2str(Arming_th2),'fC (',num2str(Arming_th2 * 6241.51),'e)','(',num2str(arm_dac2),')'];
str2 = ['',num2str(Pre_Gain),',',num2str(Peaking_time)];
x0=5;y0=stop_fc -.5;
x1=x0;y1=y0-2;
x2=x0;y2=y1-2;
...
str0 = ['',VFAT3_NUMBER];
str1 = ['ArmDac:',num2str(Arming_th3),'fC (',num2str(Arming_th3 * 6241.51),'e)','(',num2str(arm_dac3),')'];
str2 = ['',num2str(Pre_Gain),',',num2str(Peaking_time)];
x0=5;y0=stop_fc -.5;
x1=x0;y1=y0-2;
x2=x0;y2=y1-2;
...
str0 = ['',VFAT3_NUMBER];
str1 = ['ArmDac:',num2str(Arming_th4),'fC (',num2str(Arming_th4 * 6241.51),'e)','(',num2str(arm_dac4),')'];
str2 = ['',num2str(Pre_Gain),',',num2str(Peaking_time)];
x0=5;y0=stop_fc -.5;
x1=x0;y1=y0-2;
x2=x0;y2=y1-2;
...
str0 = ['',VFAT3_NUMBER];
str1 = ['ArmDac:',num2str(Arming_th5),'fC (',num2str(Arming_th5 * 6241.51),'e)','(',num2str(arm_dac5),')'];
str2 = ['',num2str(Pre_Gain),',',num2str(Peaking_time)];
x0=5;y0=stop_fc -.5;
x1=x0;y1=y0-2;
x2=x0;y2=y1-2;
...
%%
fprintf('Trimming_gain_T1 = %f\n',M_O_mean_Th_std/M_O_mean_Th_std_T1);
fprintf('Trimming_gain_T2 = %f\n',M_O_mean_Th_std/M_O_mean_Th_std_T2);
fprintf('Trimming_gain_T3 = %f\n',M_O_mean_Th_std/M_O_mean_Th_std_T3);
fprintf('Trimming_gain_T4 = %f\n',M_O_mean_Th_std/M_O_mean_Th_std_T4);
fprintf('Trimming_gain_T5 = %f\n',M_O_mean_Th_std/M_O_mean_Th_std_T5);
